# -*- coding: utf-8 -*-
"""Proyecto_1_Medios_Circune_Arenas_Bermeo.ipynb
...
* Siguiendo, en este apartado, se probará un sistema similar a la primera simulación realizada en este código, pero esta vez se ejecutará una simulación donde Júpiter tendrá el 0.5 de su masa normal , ya que permitirá observar cómo varía la estabilidad de la partícula en función de la masa de Júpiter.
